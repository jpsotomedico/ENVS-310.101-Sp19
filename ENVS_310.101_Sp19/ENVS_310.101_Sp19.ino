...
//  LEDLights();
  ...
  temperature = myThermistor();          // read your temperature sensor to execute temperature compensation
  ecValue =  ec.readEC(voltage, temperature); // convert voltage to EC with temperature compensation
  // Serial.print("temperature:");
  // Serial.print(temperature,1);
  // Serial.print("^C  EC:");
  //  Serial.print(ecValue,2);
  outputVoltage = ecValue;
...
void LEDLights3() {
  ...
  for (int z = 1; z < 24; z = z + 3) {
    leds[z] = CRGB::Red;
  };
  for (int z = 2; z < 24; z = z + 3) {
    leds[z] = CRGB::White;
  };
  FastLED.show();
  delay(10);
